...
public class Act_Empresas_Biguacu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_empresas_biguacu);
        ...
        linha.add("Sorocaba-Florianópolis");
        ...
        this.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView adapterView, View view, int position, long ld) {
                Intent intent = new Intent(Act_Empresas_Biguacu.this, Act_Empresas_Biguacu_WebView.class);
