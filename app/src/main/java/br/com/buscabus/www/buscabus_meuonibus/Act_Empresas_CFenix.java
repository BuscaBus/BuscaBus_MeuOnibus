...
public class Act_Empresas_CFenix extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_empresas_c_fenix);
        ...
        linha.add("135 - Volta ao Morro/Carvoeira Norte via TITRI");
        linha.add("136 - Volta ao Morro/Carvoeira Sul via TITRI");
        linha.add("137 - Volta ao Morro/Pantanal Norte via TITRI");
        linha.add("138 - Volta ao Morro/Pantanal Sul via TITRI");
        ...
        linha.add("261 - Capivari via Graciliano Gomes");
        ...
        linha.add("287 - Rio Vermelho via Vargem Grande");
        linha.add("288 - Circular Rio Vermelho");
        linha.add("289 - Vargem Grande via Rio Vermelho");
        ...
        linha.add("844 - Bairro de Fátima via Aracy Vaz Callado");
        ...
        this.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView adapterView, View view, int position, long ld) {
                Intent intent = new Intent(Act_Empresas_CFenix.this, Act_Empresas_CFenix_WebView.class);
