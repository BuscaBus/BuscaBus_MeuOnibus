...
public class Act_Op_Hor_Linh_Estrela extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_op_hor_linh_estrela);
        ...
        adaptador = new ArrayAdapter<String>(Act_Op_Hor_Linh_Estrela.this, android.R.layout.simple_list_item_1, linha);
        ...
        this.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView adapterView, View view, int position, long ld) {
                Intent intent = new Intent(Act_Op_Hor_Linh_Estrela.this, Act_Op_Hor_Linh_Estrela_WebHor.class);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                if(linha.contains(query)){
                    ...
                    Toast.makeText(Act_Op_Hor_Linh_Estrela.this, "Linha não encontrada",Toast.LENGTH_LONG).show();
                }
                return false;
            }
