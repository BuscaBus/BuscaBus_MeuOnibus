...
public class Act_Op_Map_Linh_CFenix extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act__op__map__linh__c_fenix);
        ...
        adaptador = new ArrayAdapter<String>(Act_Op_Map_Linh_CFenix.this, android.R.layout.simple_list_item_1, linha);
        ...
        this.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView adapterView, View view, int position, long ld) {
                Intent intent = new Intent(Act_Op_Map_Linh_CFenix.this, Act_Op_Map_Linh_CFenix_WebMap.class);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                if(linha.contains(query)){
                    ...
                    Toast.makeText(Act_Op_Map_Linh_CFenix.this, "Linha não encontrada",Toast.LENGTH_LONG).show();
                }
                return false;
            }
