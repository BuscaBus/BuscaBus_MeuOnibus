...
public class Act_Empresas_Jotur extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linha.add("Barra do Aririu-Ponte do Imaruim (Circular)");
        ...
        linha.add("Bela Vista-Ponte do Imaruim");
        linha.add("Bela Vista-Florianópolis");
        linha.add("Caminho Novo/Terra Nova-Palhoça");
        ...
        linha.add("Enseada do Brito-Ponte do Imaruim");
        ...
        linha.add("Guarda do Cubatão-Ponte do Imaruim");
        linha.add("Guarda do Cubatão-Ponte do Imaruim (Circular)");
