...
public class Act_Empresas_Jotur extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_empresas_jotur);
        ...
        linha.add("Barra do Aririu-Palhoça (Praça) Circular");
        ...
        linha.add("Bela Vista-Palhoça (Praça)");
        linha.add("Bela Vista-Florianópolis");
        linha.add("Caminho Novo/Terra Nova-Palhoça (Praça)");
        linha.add("Caminho Novo/Terra Nova-Florianópolis");
        linha.add("Cidade Univercitária - Interbairros (Circular)");
        linha.add("Cidade Univercitária-Palhoça (Praça)");
        linha.add("Diretão");
        //linha.add("Diretão Executivo");
        //linha.add("Enseada do Brito (Escolar)");
        linha.add("Enseada-Ponte do Imaruim (Praça)");
        ...
        linha.add("Guarda do Cubatão-Palhoça (Praça)");
        linha.add("Guarda do Cubatão-Palhoça (Praça) Circular");
        ...
        linha.add("Interbairros - Região Sul");
        ...
        //linha.add("Unisul-Ponte do Imaruim");
        ...
        this.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView adapterView, View view, int position, long ld) {
                Intent intent = new Intent(Act_Empresas_Jotur.this, Act_Empresas_Jotur_WebView.class);
