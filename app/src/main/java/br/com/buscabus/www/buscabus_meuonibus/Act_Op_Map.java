...
public class Act_Op_Map extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.act__op__map);
        ...
        Btn_CFenix.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent it = new Intent(Act_Op_Map.this, Act_Op_Map_Linh_CFenix.class);
                startActivity(it);
            }
        ...
        Btn_Biguacu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent(Act_Op_Map.this, Act_Op_Hor_Linh_Biguacu.class);
                startActivity(it);
            }
        ...
        Btn_Estrela.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent(Act_Op_Map.this, Act_Op_Hor_Linh_Estrela.class);
                startActivity(it);
            }
        ...
        Btn_Imperatriz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent(Act_Op_Map.this, Act_Op_Hor_Linh_Imperatriz.class);
                startActivity(it);
            }
        ...
        Btn_Jotur.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent(Act_Op_Map.this, Act_Op_Hor_Linh_Jotur.class);
                startActivity(it);
            }
        ...
        Btn_STerezinha.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent(Act_Op_Map.this, Act_Op_Hor_Linh_STerezinha.class);
                startActivity(it);
            }
